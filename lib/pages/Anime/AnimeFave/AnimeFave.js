...
class AnimeFave extends React.Component {
  ...
  handleError (error) {
    ...
    console.log(this.state.edges) // console.log(typeof this.state.edges[0].node.coverImage.large)
  ...
  render () {
    ...
    const animeFavs = animeData.map(d => /* #__PURE__ */React.createElement('ul', {
      ...
      color: 'green',
      active: true
    }, d.node.episodes, '/', d.node.episodes)), /* #__PURE__ */React.createElement(AnimeDescription, null, d.node.description.replace(/(<([^>]+)>)/ig, '')))))))) // Define the config we'll need for our Api request

    return /* #__PURE__ */React.createElement(Layout, {
      user: user
    }, /* #__PURE__ */React.createElement('div', null, /* #__PURE__ */React.createElement(SectionTitle, null, 'My Favourites'), /* #__PURE__ */React.createElement('div', null, animeFavs)))
  }
}
